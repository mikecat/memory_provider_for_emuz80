...
GPR_LAST = GPR_LAST + SIZE
	...
	ALLOCATE_GPR PRINT_BCD2_BUFFER, 1
...
LOAD_CONFIG_LOOP
	...
	COMF GPR_CLOCK_MODE, W, A
	BNZ CONFIG_CLOCK_MODE_ALREADY_SET
	MOVLW CLOCK_MODE_NCO
	MOVWF GPR_CLOCK_MODE, A
CONFIG_CLOCK_MODE_ALREADY_SET
...
CONFIG_CLOCK_FREQUENCY_ALREADY_SET
	...
	BCF TRISA, 4, B
	; set RA3 (CLK) to output (if clock mode is not OFF)
	TSTFSZ GPR_CLOCK_MODE, A
	BCF TRISA, 3, B
...
; print BCD number in register W
; modifies W
PRINT_BCD2
	MOVWF PRINT_BCD2_BUFFER, A
	SWAPF PRINT_BCD2_BUFFER, W, A
	ANDLW 0x0F
	ADDLW '0'
	CALL PUT_CHAR
	MOVF PRINT_BCD2_BUFFER, W, A
	ANDLW 0x0F
	ADDLW '0'
	GOTO PUT_CHAR
...
CONFIG_MENU
	SET_TBLPTR_PUT_STRING CLOCK_MODE_MESSAGE
	MOVF GPR_CLOCK_MODE, W, A
	BNZ CONFIG_MENU_CLOCK_MODE_NOT_OFF
	MOVLW 'O'
	CALL PUT_CHAR
	MOVLW 'F'
	CALL PUT_CHAR
	CALL PUT_CHAR
	BRA CONFIG_MENU_CLOCK_MODE_END
CONFIG_MENU_CLOCK_MODE_NOT_OFF
	ADDLW -1
	BNZ CONFIG_MENU_CLOCK_MODE_NOT_NCO
	MOVLW 'N'
	CALL PUT_CHAR
	MOVLW 'C'
	CALL PUT_CHAR
	...
	CALL PUT_CHAR
	BRA CONFIG_MENU_CLOCK_MODE_END
CONFIG_MENU_CLOCK_MODE_NOT_NCO
	MOVLW '?'
	CALL PUT_CHAR
CONFIG_MENU_CLOCK_MODE_END
