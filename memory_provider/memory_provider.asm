...
INTERRUPT_HANDLER_CLC2_WAIT_RD_CLEAR
	BTFSS PORTA, 5, A
	BRA INTERRUPT_HANDLER_CLC2_WAIT_RD_CLEAR
	; stop emitting value
	COMF TRISC, F, A
	; done
	RETFIE 1
...
INTERRUPT_HANDLER_CLC3
	...
	BCF PIR7, CLC3IF, A
	; wait until RD goes HIGH
INTERRUPT_HANDLER_CLC3_WAIT_RD_CLEAR
	BTFSS PORTA, 5, A
	BRA INTERRUPT_HANDLER_CLC3_WAIT_RD_CLEAR
	; stop emitting value
	COMF TRISC, F, A
	; done
	RETFIE 1
...
INTERRUPT_HANDLER_CLC5_E000
	...
	BCF PIR10, CLC5IF, A
	; wait until RD goes HIGH
INTERRUPT_HANDLER_CLC5_E000_WAIT_RD_CLEAR
	BTFSS PORTA, 5, A
	BRA INTERRUPT_HANDLER_CLC5_E000_WAIT_RD_CLEAR
	; stop emitting value
	COMF TRISC, F, A
	; done
	RETFIE 1
...
INTERRUPT_HANDLER_CLC5_E001
	...
	BCF PIR10, CLC5IF, A
	; wait until RD goes HIGH
INTERRUPT_HANDLER_CLC5_E001_WAIT_RD_CLEAR
	BTFSS PORTA, 5, A
	BRA INTERRUPT_HANDLER_CLC5_E001_WAIT_RD_CLEAR
	; stop emitting value
	COMF TRISC, F, A
	; done
	RETFIE 1
